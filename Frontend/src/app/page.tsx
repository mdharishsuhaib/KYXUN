    ...
    <main id="main-content" className="kyxun-page relative w-full overflow-hidden min-h-screen">
      ...
      {isDark && (
        <>
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(132,204,22,0.3) 0%, rgba(168,85,247,0.15) 50%, transparent 100%)", animationDuration: "25s" }}
          />
          <div
      ...
      <header className="kyxun-header sticky top-0 z-50 w-full border-b border-[var(--kyxun-border)] bg-[var(--kyxun-bg)]">
        <div className="w-full px-4 sm:px-8 py-4 flex justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 shrink-0">
            <button
              onClick={toggleTheme}
              className="w-9 h-9 flex items-center justify-center rounded-lg cursor-pointer hover:bg-[var(--kyxun-hover-bg)] transition-colors shrink-0"
      ...
      <section id="hero" className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-16 z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[85vh]">
        ...
        <div className="lg:col-span-8 flex flex-col items-start text-left space-y-6">
          ...
          <span className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full text-xs font-black border kyxun-badge-lime shadow-[0_0_35px_rgba(168,85,247,0.15)]">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto pt-4">
            ...
            <Link
              href="/signup"
              className="px-9 py-5 rounded-2xl font-black text-xl text-white text-center transition-all hover:scale-[1.03] active:scale-[0.97] bg-[#65A30D]"
            >
              Create Plan
            </Link>
        ...
        <div className="lg:col-span-4 relative w-full flex items-center justify-center lg:justify-end">
          {/* Main Console Box */}
          <div className="w-full glass-panel rounded-3xl p-6 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] shadow-[0_0_60px_rgba(132,204,22,0.2)] relative z-20 overflow-hidden">
            ...
            <div className="flex items-center gap-2 border-b border-[var(--kyxun-border)] pb-4 mb-5">
              <div className="flex-1 flex items-center gap-2 bg-[var(--kyxun-input-bg)] border border-[var(--kyxun-border)] rounded-lg px-3 py-1.5 min-w-0">
                ...
                <span className="text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-bold truncate">kyxun.app/dashboard</span>
              </div>
            ...
            <div className="border-2 border-dashed border-[var(--kyxun-border)] rounded-2xl p-9 text-center bg-[var(--kyxun-input-bg)] hover:bg-[var(--kyxun-hover-bg)] hover:border-[var(--kyxun-accent)] transition-all cursor-pointer group relative overflow-hidden">
              ...
              <div className="w-16 h-16 rounded-2xl kyxun-badge-lime flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full kyxun-badge-lime text-[10px] font-mono   font-bold shadow-[0_0_10px_rgba(132,204,22,0.2)]">
            ...
            <div className="mt-4 space-y-2.5">
              <div className="p-4 rounded-xl border border-[var(--kyxun-border)] bg-[var(--kyxun-surface)] flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg kyxun-badge-lime flex items-center justify-center">
                    <Check className="w-5 h-5  " />
                  </div>
                  <div>
                    <h4 className="text-xs font-black text-[var(--kyxun-text)]">Parser Core Ready</h4>
                    <p className="text-[10px] text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-mono">Files processed in temporary memory only</p>
                  </div>
                </div>
                <span className="text-[10px] font-mono   kyxun-badge-lime px-3 py-1 rounded-lg font-bold">SECURE</span>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 py-24 relative z-10 border-t border-[var(--kyxun-border)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-8">
          <div className="lg:col-span-7">
            <span className="  kyxun-badge-lime text-xs font-bold uppercase tracking-widest px-4 py-2 rounded-full border font-mono shadow-[0_0_12px_rgba(132,204,22,0.2)]">
              VISION OCR LAYER
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="glass-panel rounded-3xl p-6 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] relative overflow-hidden shadow-2xl">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-bold">{item.name}</span>
                      ...
                      <div className="flex justify-between items-center mt-2 text-[9px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-t border-[var(--kyxun-border)] pt-3 mt-4 gap-1 text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400">
          ...
          <div className="lg:col-span-5">
            <div className="glass-panel rounded-3xl p-6 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] shadow-2xl relative overflow-hidden h-full min-h-[420px] flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between border-b border-[var(--kyxun-border)] pb-3 mb-4 text-[var(--kyxun-text-subtle)] dark:text-slate-400 text-[10px] font-mono">
                ...
                <div className="space-y-3 font-mono text-xs text-[var(--kyxun-text)] select-text leading-relaxed">
                  ...
                  <p className="text-[var(--kyxun-text-subtle)] dark:text-slate-400 opacity-50 font-bold">{"-----------------------------------------"}</p>
              ...
              <div className="border-t border-[var(--kyxun-border)] pt-3 text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400 mt-6">
                Click on the formulas to scan another card.
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-4 sm:px-6 py-24 relative z-10 border-t border-[var(--kyxun-border)]">
        <div className="text-center mb-16">
          <span className="  kyxun-badge-lime text-xs font-bold uppercase tracking-widest px-4 py-2 rounded-full border font-mono shadow-[0_0_12px_rgba(168,85,247,0.2)]">
            VISUAL STORYTELLING
          </span>
          <h2 className="font-outfit text-4xl sm:text-5xl lg:text-6xl font-black text-[var(--kyxun-text)] mt-4 tracking-tight leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch max-w-6xl mx-auto">
          ...
          <div className="md:col-span-7 glass-panel glass-panel-hover rounded-3xl p-7 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] relative overflow-hidden min-h-[260px] flex flex-col justify-between group shadow-xl">
              ...
              <div className="flex justify-between items-center mb-4">
                <span className="text-[11px] font-mono   kyxun-badge-lime px-3 py-1 rounded-full font-bold shadow-[0_0_8px_rgba(132,204,22,0.2)]">
                  Step 1 // Upload
                </span>
                <span className="text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-bold">Ingest Syllabus</span>
              </div>
            ...
            <div className="flex items-center gap-3 mt-5 font-mono text-[10px] text-[var(--kyxun-text-muted)] bg-[var(--kyxun-input-bg)] border border-[var(--kyxun-border)] p-3 rounded-xl">
              ...
              <span className="  kyxun-badge-lime px-2.5 py-0.5 rounded font-black ml-auto">✓ SECURE</span>
            </div>
          </div>
          ...
          <div className="md:col-span-5 glass-panel glass-panel-hover rounded-3xl p-7 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] relative overflow-hidden min-h-[260px] flex flex-col justify-between group shadow-xl">
            <div className="absolute top-0 right-0 w-32 h-32 kyxun-badge-lime rounded-full blur-2xl group-hover:kyxun-badge-lime transition-all" />
            <div>
              <div className="flex justify-between items-center mb-4">
                <span className="text-[11px] font-mono   kyxun-badge-lime px-3 py-1 rounded-full font-bold shadow-[0_0_8px_rgba(168,85,247,0.2)]">
                  Step 2 // AI Analysis
                </span>
                <span className="text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-bold">Yield Classifier</span>
              </div>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2 text-[9px] font-mono">
              <span className="px-3 py-1.5 rounded-lg   kyxun-badge-lime font-bold shadow-[0_0_8px_rgba(244,63,94,0.15)]">
                SKIP: Low-weight appendix (Saved 3h)
              </span>
              <span className="px-3 py-1.5 rounded-lg   kyxun-badge-lime font-bold">
                FOCUS: Core Theorems
              </span>
            </div>
          </div>
          ...
          <div className="md:col-span-5 glass-panel glass-panel-hover rounded-3xl p-7 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] relative overflow-hidden min-h-[260px] flex flex-col justify-between group shadow-xl">
                        <div>
              <div className="flex justify-between items-center mb-4">
                <span className="text-[11px] font-mono   kyxun-badge-lime px-3 py-1 rounded-full font-bold shadow-[0_0_8px_rgba(244,63,94,0.2)]">
                  Step 3 // Practice
                </span>
                <span className="text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-bold">Active Recall</span>
              </div>
          ...
          <div className="md:col-span-7 glass-panel glass-panel-hover rounded-3xl p-7 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] relative overflow-hidden min-h-[260px] flex flex-col justify-between group shadow-xl">
                        <div>
              <div className="flex justify-between items-center mb-4">
                <span className="text-[11px] font-mono   kyxun-badge-lime px-3 py-1 rounded-full font-bold shadow-[0_0_8px_rgba(6,182,212,0.2)]">
                  Step 4 // Simulate
                </span>
                <span className="text-[10px] font-mono text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-bold">Viva Practice</span>
              </div>
            ...
            <table className="w-full text-left border-collapse text-xs sm:text-sm min-w-[560px]">
              <thead>
                <tr className="border-b border-[var(--kyxun-border)] bg-[var(--kyxun-bg-secondary)]">
                  ...
                  <th className="p-6 font-outfit font-black text-base text-[var(--kyxun-text-subtle)] dark:text-slate-400">Standard AI Chatbots</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--kyxun-border)] font-bold text-[var(--kyxun-text-muted)]">
                <tr>
                  ...
                  <td className="p-6 text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-normal">Converts image to unformatted text</td>
                </tr>
                <tr>
                  ...
                  <td className="p-6 text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-normal">No connection to academic statistics</td>
                </tr>
                <tr>
                  ...
                  <td className="p-6 text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-normal">Tells you to read everything</td>
                </tr>
                <tr>
                  ...
                  <td className="p-6 text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-normal">Text-only responses</td>
                </tr>
                <tr>
                  ...
                  <td className="p-6 text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-normal">May store inputs for model training</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section id="pricing" className="max-w-7xl mx-auto px-4 sm:px-6 py-24 relative z-10 border-t border-[var(--kyxun-border)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
          ...
          <div className="glass-panel rounded-3xl p-8 border border-[var(--kyxun-border)] bg-[var(--kyxun-glass)] flex flex-col shadow-xl">
            <div className="mb-6">
              <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--kyxun-text-subtle)] dark:text-slate-400">FREE FOREVER</span>
              ...
              <div className="flex items-end gap-1 mt-3">
                ...
                <span className="text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-semibold mb-2">/month</span>
              </div>
            </div>
            ...
            <Link
              href="/signup"
              className="w-full py-4 rounded-2xl font-black text-base text-white text-center bg-[#65A30D] transition-transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Get Started
            </Link>
          </div>
          ...
          {/* Pro Plan */}
          <div className="glass-panel rounded-3xl p-8 border-2 border-[var(--kyxun-accent)] bg-[var(--kyxun-glass)] flex flex-col shadow-[0_0_60px_rgba(132,204,22,0.2)] relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 kyxun-badge-lime rounded-full blur-3xl" />
            <div className="mb-6">
              <span className="inline-flex items-center gap-1.5 text-[10px] font-mono font-bold uppercase tracking-widest   kyxun-badge-lime px-3 py-1 rounded-full">
              ...
              <p className="text-xs text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-mono mt-1">or $24 for exam season (3 months)</p>
            </div>
            <ul className="space-y-3 flex-1 mb-8">
              {[
            ...
            <Link
              href="/signup"
              className="w-full py-4 rounded-2xl font-black text-base text-white text-center transition-all hover:scale-[1.02] active:scale-[0.98] bg-[#65A30D]"
            >
              Grab Pro
            </Link>
          </div>
      ...
      <footer className="relative z-50 bg-[var(--kyxun-bg)] border-t border-[var(--kyxun-border)] pt-16 pb-12 w-full mt-auto">
        <div className="w-full px-4 sm:px-8">
          ...
          <div className="max-w-xs">
            ...
            <p className="text-sm text-[var(--kyxun-text-subtle)] dark:text-slate-400 font-semibold leading-relaxed">
          ...
          <div className="flex gap-12 sm:gap-24">
            <div>
              <h4 className="text-[10px] font-mono font-black uppercase tracking-widest text-[var(--kyxun-text-subtle)] dark:text-slate-400 mb-5">PRODUCT</h4>
              <ul className="space-y-4">
                {[["Features", "#survival-plans"], ["How It Works", "#how-it-works"], ["Pricing", "#pricing"]].map(([label, href]) => (
                  <li key={label}>
                    <a href={href} className="text-sm font-semibold text-[var(--kyxun-text-muted)] hover:text-[var(--kyxun-accent)] hover:underline underline-offset-4 transition-all">{label}</a>
                  </li>
                ))}
              </ul>
            </div>
            <div id="contact">
              <h4 className="text-[10px] font-mono font-black uppercase tracking-widest text-[var(--kyxun-text-subtle)] dark:text-slate-400 mb-5">CONTACT</h4>
              <ul className="space-y-4">
                <li>
        ...
        <div className="border-t border-[var(--kyxun-border)] pt-8 flex flex-col items-center justify-center gap-6 relative">
          <p className="text-xs font-semibold text-[var(--kyxun-text-subtle)] dark:text-slate-400 text-center">
